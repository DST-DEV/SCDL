...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.radioButton_3 = QtWidgets.QRadioButton(parent=self.tab_scdl)
        ...
        self.BtnGroup_extr_pl_save_mode.addButton(self.radioButton_3)
        self.verticalLayout_5.addWidget(self.radioButton_3)
        self.radioButton_4 = QtWidgets.QRadioButton(parent=self.tab_scdl)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.BtnGroup_extr_pl_save_mode.addButton(self.radioButton_4)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButton_3.setToolTip(_translate("MainWindow", "<html><head/><body><p>Replace the current playlists list with the results from the search</p></body></html>"))
        self.radioButton_3.setText(_translate("MainWindow", "Replace current playlists"))
        self.radioButton_4.setToolTip(_translate("MainWindow", "<html><head/><body><p>Add results from the search to the current playlists list</p></body></html>"))
        self.radioButton_4.setText(_translate("MainWindow", "Append to current playlists"))
