...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.glayout_SCDL.addItem(spacerItem, 7, 0, 1, 1)
        ...
        self.glayout_dl_hist.addItem(spacerItem6, 6, 1, 1, 1)
        ...
        self.glayout_SCDL.addLayout(self.glayout_track_ext, 6, 0, 1, 1)
        self.line_3 = QtWidgets.QFrame(parent=self.tab_scdl)
        self.line_3.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line_3.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line_3.setObjectName("line_3")
        self.glayout_SCDL.addWidget(self.line_3, 12, 0, 1, 1)
        ...
        self.glayout_pl_search.addItem(spacerItem11, 2, 0, 1, 1)
        ...
        self.BtnGroup_extr_pl_search_mode = QtWidgets.QButtonGroup(MainWindow)
        self.BtnGroup_extr_pl_search_mode.setObjectName("BtnGroup_extr_pl_search_mode")
        self.BtnGroup_extr_pl_search_mode.addButton(self.rbtn_pl_all)
        self.glayout_pl_search.addWidget(self.rbtn_pl_all, 4, 1, 1, 1)
        self.line_pl_search_top = QtWidgets.QFrame(parent=self.tab_scdl)
        self.line_pl_search_top.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line_pl_search_top.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line_pl_search_top.setObjectName("line_pl_search_top")
        self.glayout_pl_search.addWidget(self.line_pl_search_top, 3, 1, 1, 1)
        self.verticalLayout_5 = QtWidgets.QVBoxLayout()
        self.verticalLayout_5.setSizeConstraint(QtWidgets.QLayout.SizeConstraint.SetMinimumSize)
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.rbtn_pl_search_repl = QtWidgets.QRadioButton(parent=self.tab_scdl)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.rbtn_pl_search_repl.sizePolicy().hasHeightForWidth())
        self.rbtn_pl_search_repl.setSizePolicy(sizePolicy)
        self.rbtn_pl_search_repl.setChecked(True)
        self.rbtn_pl_search_repl.setObjectName("rbtn_pl_search_repl")
        self.BtnGroup_extr_pl_save_mode = QtWidgets.QButtonGroup(MainWindow)
        self.BtnGroup_extr_pl_save_mode.setObjectName("BtnGroup_extr_pl_save_mode")
        self.BtnGroup_extr_pl_save_mode.addButton(self.rbtn_pl_search_repl)
        self.verticalLayout_5.addWidget(self.rbtn_pl_search_repl)
        self.rbtn_pl_search_append = QtWidgets.QRadioButton(parent=self.tab_scdl)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.rbtn_pl_search_append.sizePolicy().hasHeightForWidth())
        self.rbtn_pl_search_append.setSizePolicy(sizePolicy)
        self.rbtn_pl_search_append.setObjectName("rbtn_pl_search_append")
        self.BtnGroup_extr_pl_save_mode.addButton(self.rbtn_pl_search_append)
        self.verticalLayout_5.addWidget(self.rbtn_pl_search_append)
        self.glayout_pl_search.addLayout(self.verticalLayout_5, 9, 1, 1, 1)
        ...
        self.BtnGroup_extr_pl_search_mode.addButton(self.rbtn_pl_search_key)
        ...
        self.line_pl_search_middle = QtWidgets.QFrame(parent=self.tab_scdl)
        self.line_pl_search_middle.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line_pl_search_middle.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line_pl_search_middle.setObjectName("line_pl_search_middle")
        self.glayout_pl_search.addWidget(self.line_pl_search_middle, 8, 1, 1, 1)
        spacerItem12 = QtWidgets.QSpacerItem(5, 20, QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Minimum)
        self.glayout_pl_search.addItem(spacerItem12, 2, 2, 1, 1)
        ...
        self.BtnGroup_extr_pl_search_mode.addButton(self.rbtn_pl_search_name)
        ...
        self.glayout_SCDL.addLayout(self.glayout_pl_search, 2, 0, 1, 1)
        ...
        self.glayout_msg.addWidget(self.progressBar, 0, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.rbtn_pl_search_repl.setToolTip(_translate("MainWindow", "<html><head/><body><p>Replace the current playlists list with the results from the search</p></body></html>"))
        self.rbtn_pl_search_repl.setText(_translate("MainWindow", "Replace current playlists"))
        self.rbtn_pl_search_append.setToolTip(_translate("MainWindow", "<html><head/><body><p>Add results from the search to the current playlists list</p></body></html>"))
        self.rbtn_pl_search_append.setText(_translate("MainWindow", "Append to current playlists"))
