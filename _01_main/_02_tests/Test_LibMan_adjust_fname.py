...
# =============================================================================
#         
#         #Step 8: Convert to title type and remove leading and tailing spaces 
#         # as well as double (or more) spaces
#         new_filename = re.sub(r"\s+", " ", new_filename).title().strip()
# =============================================================================
        
        #Step 9: Replace 'T by 't (for english words (e.g. don't))
        new_filename = re.sub(r"\b('t)", "'t", new_filename)
