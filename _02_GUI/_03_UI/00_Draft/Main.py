...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboBox_tbl_left = QtWidgets.QComboBox(parent=self.gridLayoutWidget_5)
        ...
        self.cb_red_view_tbl_left = QtWidgets.QCheckBox(parent=self.gridLayoutWidget_5)
        ...
        self.line_tbl_left_2 = QtWidgets.QFrame(parent=self.gridLayoutWidget_5)
        ...
        self.cb_red_view_tbl_right = QtWidgets.QCheckBox(parent=self.gridLayoutWidget_5)
        ...
        self.comboBox_tbl_right = QtWidgets.QComboBox(parent=self.gridLayoutWidget_5)
        ...
        self.line_tbl_right_2 = QtWidgets.QFrame(parent=self.gridLayoutWidget_5)
        ...
        self.gridLayoutWidget_4.setGeometry(QtCore.QRect(0, 0, 261, 531))
        ...
        self.cb_use_cached = QtWidgets.QCheckBox(parent=self.gridLayoutWidget_4)
        ...
        self.line_pl_search = QtWidgets.QFrame(parent=self.gridLayoutWidget_4)
        ...
        self.line_3 = QtWidgets.QFrame(parent=self.gridLayoutWidget_4)
        ...
        self.btn_dl_hist_up = QtWidgets.QPushButton(parent=self.gridLayoutWidget_4)
        self.btn_dl_hist_up.setObjectName("btn_dl_hist_up")
        self.glayout_dl_hist.addWidget(self.btn_dl_hist_up, 2, 1, 1, 1)
        self.rbtn_curr_pl = QtWidgets.QRadioButton(parent=self.gridLayoutWidget_4)
        ...
        self.lbl_hist_up = QtWidgets.QLabel(parent=self.gridLayoutWidget_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.rbtn_all_pl = QtWidgets.QRadioButton(parent=self.gridLayoutWidget_4)
        ...
        self.cb_repl_ex_files = QtWidgets.QCheckBox(parent=self.gridLayoutWidget_6)
        ...
        self.btn_del_ex_files = QtWidgets.QPushButton(parent=self.gridLayoutWidget_6)
