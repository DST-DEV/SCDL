...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout_dl_hist = QtWidgets.QGridLayout()
        self.gridLayout_dl_hist.setObjectName("gridLayout_dl_hist")
        self.rbtn_all_pl = QtWidgets.QRadioButton(parent=self.verticalLayoutWidget)
        self.rbtn_all_pl.setObjectName("rbtn_all_pl")
        self.gridLayout_dl_hist.addWidget(self.rbtn_all_pl, 3, 1, 1, 1)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout_dl_hist.addItem(spacerItem, 2, 0, 2, 1)
        self.rbtn_curr_pl = QtWidgets.QRadioButton(parent=self.verticalLayoutWidget)
        self.rbtn_curr_pl.setChecked(True)
        self.rbtn_curr_pl.setObjectName("rbtn_curr_pl")
        self.gridLayout_dl_hist.addWidget(self.rbtn_curr_pl, 2, 1, 1, 1)
        spacerItem1 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout_dl_hist.addItem(spacerItem1, 2, 2, 2, 1)
        self.btn_dl_hist_up = QtWidgets.QPushButton(parent=self.verticalLayoutWidget)
        self.btn_dl_hist_up.setObjectName("btn_dl_hist_up")
        self.gridLayout_dl_hist.addWidget(self.btn_dl_hist_up, 1, 0, 1, 3)
        self.lbl_DL_history = QtWidgets.QLabel(parent=self.verticalLayoutWidget)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.lbl_DL_history.setFont(font)
        self.lbl_DL_history.setObjectName("lbl_DL_history")
        self.gridLayout_dl_hist.addWidget(self.lbl_DL_history, 0, 0, 1, 3)
        self.gridLayout_dl_hist.setColumnStretch(0, 1)
        self.gridLayout_dl_hist.setColumnStretch(1, 40)
        self.gridLayout_dl_hist.setColumnStretch(2, 1)
        self.gridLayout_dl_hist.setRowStretch(0, 1)
        self.gridLayout_dl_hist.setRowStretch(1, 1)
        self.gridLayout_dl_hist.setRowStretch(2, 1)
        self.gridLayout_dl_hist.setRowStretch(3, 1)
        self.verticalLayout.addLayout(self.gridLayout_dl_hist)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.rbtn_all_pl.setText(_translate("Dialog", "All playlists"))
        self.rbtn_curr_pl.setText(_translate("Dialog", "Current playlists"))
        self.btn_dl_hist_up.setText(_translate("Dialog", "Update DL History"))
        self.lbl_DL_history.setText(_translate("Dialog", "Download History"))
